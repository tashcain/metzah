...
//course
import LessLayout from "../pages/lessonLayout/lessonLayout";
...
//metzah Relevant
import IeltsHome from "../pages/IeltsHome/IeltsHome";
import Profile from "../pages/profile/profile";
import Reading from "../pages/IeltsHome/IeltsSub/reading";
import Listening from "../pages/IeltsHome/IeltsSub/listening";
import Layout from "../pages/IeltsHome/layouts/layout";
import AudioLayout from "../pages/IeltsHome/layouts/audioLayout";
import Writing from "../pages/IeltsHome/IeltsSub/writing";
import GenVideoTab from "../pages/IeltsHome/IeltsSub/genVidTab";
import WritingLayout from "../pages/IeltsHome/layouts/writingLayout";
import Speaking from "../pages/IeltsHome/IeltsSub/speaking";
import SpeakingLayout from "../pages/IeltsHome/layouts/speakingLayout";
import GenVideo from "../pages/IeltsHome/layouts/genVideo";
import Analytics from "../pages/analytics/analytics";
import MockTest from "../pages/IeltsHome/IeltsSub/mockTest";
...
const authProtectedRoutes = [
  ...
  //Course
  { path: "/lesson", component: LessLayout },
  { path: "/ieltshome", component: IeltsHome },
  { path: "/reading", component: Reading },
  { path: "/listening", component: Listening },
  { path: "/writing", component: Writing },
  { path: "/speaking", component: Speaking },
  { path: "/layout", component: Layout },
  { path: "/audioLayout", component: AudioLayout },
  { path: "/writingLayout", component: WritingLayout },
  { path: "/speakingLayout", component: SpeakingLayout },
  { path: "/genVid", component: GenVideo },
  { path: "/genVidTab", component: GenVideoTab },
