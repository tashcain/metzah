          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/#" className="has-arrow waves-effect">
                ...
                <span className="ml-1">{this.props.t("IELTS")}</span>
              </Link>
              <ul className="sub-menu" aria-expanded="false">
                <li>
                  <Link to="reading">{this.props.t("Reading")}</Link>
                </li>
                <li>
                  <Link to="listening">{this.props.t("Listening")}</Link>
                </li>
                <li>
                  <Link to="writing">{this.props.t("Writing")}</Link>
                </li>
                <li>
                  <Link to="speaking">{this.props.t("Speaking")}</Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              <Link to="flashcard" className=" waves-effect">
                <i className="ri-chat-1-line"></i>
                <span className="ml-1">{this.props.t("FlashCards")}</span>
              </Link>
            </li>
            <li>
              <Link to="flashcard" className=" waves-effect">
                <i className="ri-chat-1-line"></i>
                <span className="ml-1">{this.props.t("Course Details")}</span>
              </Link>
            </li>
            {/* <li>
              <Link to="flashcard" className=" waves-effect">
